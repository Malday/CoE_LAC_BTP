			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriapp-display": {
								"semanticObject": "fioriapp",
								"action": "display",
								"description": "Demo Fiori Application",
								"title": "FioriApp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriapp",
									"url": sap.ui.require.toUrl("fioriapp")
								}
							}
						}
					}
