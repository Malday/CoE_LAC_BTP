					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App Hello World",
									"targetURL": "#demoapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoapp1-display": {
								"semanticObject": "demoapp1",
								"action": "display",
								"description": "App for Hello World in DevOps Demo",
								"title": "Demo App Hello World",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoapp1",
									"url": sap.ui.require.toUrl("demoapp1")
								}
							}
						}
					}
